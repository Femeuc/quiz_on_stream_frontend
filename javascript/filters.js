...
start_button.onclick = async function() {
    ...
    localStorage.setItem('inactivity_debt', score_type == 'default' ? 0 : document.querySelector('#debt').value);
